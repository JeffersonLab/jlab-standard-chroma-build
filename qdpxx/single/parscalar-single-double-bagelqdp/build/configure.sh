...
${QDPDIR}/qdpxx/configure --prefix=${PREFIX} --with-qmp=${QMP_PREFIX} --enable-parallel-arch=parscalar CXXFLAGS="-fargument-noalias-global -O2 -finline-limit=50000" CFLAGS="-O2 -std=c99" --with-bagel-qdp=${BAGELQDP_PREFIX} --enable-precision=double
