...
${CHROMADIR}/chroma/configure --prefix=${PREFIX} --with-qdp=${QDP_PREFIX} CFLAGS="-O3 -msse -msse2 -march=pentium4" CXXFLAGS="" --enable-sse-wilson-dslash  --enable-cg-dwf=sse --with-gmp=/usr --with-qmp=${QMP_PREFIX}
