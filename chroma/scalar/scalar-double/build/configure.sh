...
${CHROMADIR}/chroma/configure --prefix=${PREFIX} --with-qdp=${QDP_PREFIX} CFLAGS="-O3 -msse -msse2 -march=nocona" \
   CXXFLAGS="" --enable-sse-wilson-dslash  --with-gmp=/usr CC=${CC} CXX=${CXX} \
