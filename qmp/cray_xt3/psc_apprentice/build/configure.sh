...
. ../../../../functions.sh
PREFIX=`make_prefix ../../../PREFIX ../../../VERSION_finst`
clean_dir ${PREFIX}
...
../../../qmp/configure --host=x86_64-unknown-linux-gnu --build=x86_64-suse-linux \
    ...
    --with-qmp-comms-ldflags="-finstrument_functions -L/opt/xt-mpt/${XTOS_VERSION}/mpich2-64/GP2/lib -L/opt/acml/3.0/gnu64/lib -L/opt/xt-libsci/${XTOS_VERSION}/gnu/cnos64/lib -L/opt/xt-mpt/${XTOS_VERSION}/sma/lib" \
