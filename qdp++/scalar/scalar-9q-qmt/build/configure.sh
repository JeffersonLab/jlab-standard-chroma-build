...
${QDPDIR}/qdp++/configure --prefix=${PREFIX} --enable-parallel-arch=scalar --enable-sse2 --with-qmt=${QMT_PREFIX} \
	CXXFLAGS="-g -fargument-noalias-global -O3 -finline-limit=50000 -march=core2 -funroll-all-loops -fpeel-loops" \
	CFLAGS="-g -fargument-noalias-global -O3 -march=core2 -funroll-all-loops -fpeel-loops" \
	CXX=g++ CC=gcc
